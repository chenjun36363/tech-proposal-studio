...
export const agentToolGroups: AgentToolGroup[] = [
  ...
  { id: "git-write", label: "Git 变更", description: "普通模式逐项审批；完全访问模式可直接暂存、提交、切换分支或访问远程" },
...
export const agentToolCatalog: AgentToolCatalogItem[] = [
  ...
  { name: "git_changes", label: "本次修改", description: "一次性读取全部已暂存、未暂存和未跟踪变更", group: "git-read" },
  ...
  { name: "git_stage", label: "暂存更改", description: "暂存文件或全部变更，普通模式审批，完全访问直接执行", group: "git-write" },
  { name: "git_unstage", label: "取消暂存", description: "取消暂存文件或全部变更，普通模式审批，完全访问直接执行", group: "git-write" },
  { name: "git_commit", label: "创建提交", description: "提交暂存区，普通模式审批，完全访问直接执行", group: "git-write" },
  { name: "git_create_branch", label: "创建分支", description: "创建并切换本地分支，普通模式审批，完全访问直接执行", group: "git-write" },
  { name: "git_switch_branch", label: "切换分支", description: "切换本地或远程分支，普通模式审批，完全访问直接执行", group: "git-write" },
  { name: "git_stash_push", label: "保存 stash", description: "保存工作区变更，普通模式审批，完全访问直接执行", group: "git-write" },
  { name: "git_stash_pop", label: "应用 stash", description: "应用最近 stash，普通模式审批，完全访问直接执行", group: "git-write" },
  { name: "git_fetch", label: "获取远程更新", description: "执行 fetch，普通模式审批，完全访问直接执行", group: "git-write" },
  { name: "git_pull", label: "拉取远程更新", description: "执行 fast-forward pull，普通模式审批，完全访问直接执行", group: "git-write" },
  { name: "git_push", label: "推送当前分支", description: "推送到 origin，普通模式审批，完全访问直接执行", group: "git-write" },
